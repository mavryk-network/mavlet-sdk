...
export interface ResponseInput {
  ...
  account: AccountInfo
  output: MavletMessageWrapper<MavletBaseMessage>
  blockExplorer: any
...
export interface MavletMessageWrapper<T extends MavletBaseMessage> {
...
export interface BlockchainResponseV3<T extends string = string> extends BlockchainMessage<T> {
  blockchainIdentifier: T
  type: MavletMessageType.BlockchainResponse
...
// Acknowledge
export interface AcknowledgeMessage extends MavletBaseMessage {
