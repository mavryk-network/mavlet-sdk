export enum MavletErrorType {
  /**
   * {@link BroadcastMavletError}
   *
  ...
  /**
   * {@link NetworkNotSupportedMavletError}
   *
  ...
  /**
   * {@link ParametersInvalidMavletError}
   *
  ...
  /**
   * {@link TooManyOperationsMavletError}
   *
  ...
  /**
   * {@link TransactionInvalidMavletError}
   *
  ...
  /**
   * {@link SignatureTypeNotSupportedMavletError}
   *
  ...
  // TODO: ENCRYPTION
  // /**
  //  * {@link EncryptionTypeNotSupportedMavletError}
  //  *
