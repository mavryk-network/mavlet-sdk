import { MavletMessage, Storage, StorageKey, PermissionInfo } from '@mavrykdynamics/mavlet-types'
...
export class PermissionManager {
  ...
  public async hasPermission(message: MavletMessage): Promise<boolean> {
