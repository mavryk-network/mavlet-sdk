...
import { NetworkType, Origin, Storage, StorageKey } from '@mavrykdynamics/mavlet-types'
...
describe(`Migrations`, () => {
  ...
  it(`migrates 0.7.0`, async () => {
    ...
    await storage.set(StorageKey.MAVLET_SDK_VERSION, '0.6.0')
    ...
    const storedSdkVersion = await storage.get(StorageKey.MAVLET_SDK_VERSION)
