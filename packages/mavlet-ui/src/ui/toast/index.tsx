...
import { WalletInfo } from '@mavrykdynamics/mavlet-types'
import { generateGUID } from '@mavrykdynamics/mavlet-utils'
...
const createToast = (config: ToastConfig) => {
  ...
  if (document.getElementById('mavlet-toast-wrapper')) {
    ;(document.getElementById('mavlet-toast-wrapper') as HTMLElement).remove()
  }
  shadowRootEl.setAttribute('id', 'mavlet-toast-wrapper')
