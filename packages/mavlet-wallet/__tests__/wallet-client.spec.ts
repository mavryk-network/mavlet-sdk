...
import { P2PTransport } from '@mavrykdynamics/mavlet-transport-matrix'
...
describe(`WalletClient`, () => {
  ...
  it(`should have a mavlet ID`, async () => {
    ...
    expect(typeof (await walletClient.mavletId)).to.equal('string')
  })
  ...
  it(`should respond with an error message`, async () => {
    ...
    const message: MavletResponseInputMessage = {
      id,
      type: MavletMessageType.Error,
      errorType: MavletErrorType.TRANSACTION_INVALID_ERROR,
      errorData: [
        {
          kind: 'temporary',
  ...
  it(`should respond with an error message`, async () => {
    ...
    const message: MavletResponseInputMessage = {
      id,
      type: MavletMessageType.Error,
      errorType: MavletErrorType.PARAMETERS_INVALID_ERROR,
      errorData: [
        {
          kind: 'temporary',
          id: 'proto.007-PsDELPH1.contract.non_existing_contract',
